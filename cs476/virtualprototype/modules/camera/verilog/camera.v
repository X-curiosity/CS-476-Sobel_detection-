module camera #(parameter [7:0] customInstructionId = 8'd0,
  ...
  reg [7:0] g_byteReg1 , g_byteReg2 , g_byteReg3, g_byteReg4; // registers for grayscale
  ...
  wire [31:0] s_8bitgrayscalePixelWord;

  /* Converting the 2 RGB pixels into grayscale*/ 
  rgb565Grayscale graypixel1( .rgb565({s_byte7Reg,s_byte6Reg}), 
                              .grayscale(g_byteReg2));
  rgb565Grayscale graypixel2( .rgb565({s_byte5Reg,s_byte4Reg}),
                              .grayscale(g_byteReg1));

  rgb565Grayscale graypixel3(
                              .rgb565({s_byte3Reg,s_byte2Reg}),
                              .grayscale(g_byteReg3));

  rgb565Grayscale graypixel4(
                              .rgb565({s_byte1Reg,camData}),
                              .grayscale(g_byteReg4));
  
  //pack grayscale pixels
  ...
  dualPortRam2k lineBuffer ( .address1({1'b0,s_pixelCountReg[10:3]}), //address 4 pixel by 4 pixel
  ...
  always @(posedge clock)
    begin
      ...
      s_nrOfPixelsPerLineReg <= (s_newLine == 1'b1) ? {1'd0,s_pixelCountValueReg[10:3] }: 
